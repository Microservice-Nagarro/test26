...
* Copy code\BHF.MS.test26\yaml\configMap-development.yml.example as "configMap-development.yml"
...
* Every single migration command requires Args parameter containing full query string to the databse, sample command below:
	* Add-Migration InitialMigration -Context CustomDbContext -Project BHF.MS.test26.Database -StartupProject BHF.MS.test26.Database -Args "Data Source=(local);Initial Catalog=test26;User ID=[user];Password=[passwsord];Trust Server Certificate=True"
